...
#
# Modified version of https://github.com/opscode/chef/blob/master/chef/lib/chef/provider/git.rb
...
def generate_GIT_SSH(private_key)
  # I'm not super satisfied with that... We'll be screwed if the version change,
  # but the gem package is apparently built like that.
  require '/usr/lib/ruby/gems/1.8/gems/git-ssh-wrapper-0.0.1/lib/git-ssh-wrapper.rb'
